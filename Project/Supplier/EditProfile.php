...
$sel="select * from tbl_supplier where supplier_id=".$_SESSION["fid"];
$res=$Conn->query($sel);
$row=$res->fetch_assoc();
...
if(isset($_POST["btn_update"]))
{
	...
	$up="update tbl_supplier set supplier_name='".$na."',supplier_contact='".$co."' , supplier_email='".$em."' , supplier_address='".$add."' where supplier_id=".$_SESSION["fid"];
	if($Conn->query($up))
	{
		?>
		<script>
