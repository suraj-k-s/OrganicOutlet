                                        ...
                                        <div class="white_box mb_30">
                                            ...
                                            <form method="post">
                                             <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="sel_district" id="sel_district" autocomplete="off" required onchange="getdistrict(this.value)" >
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <?php
	$i=0;
	  $sel = "select * from tbl_place p inner join tbl_district s on s.district_id=p.district_id";
	  $row = $Conn->query($sel);
	  while($data = $row->fetch_assoc())
	  {
		  $i++;
