                                            ...
                                            <div class="quick_activity_wrap">
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        ...
                                                        <?php
														$sel = "select count(supplier_id) as id from tbl_supplier";
                                                ...
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        <h3><span class="counter">
                                                        <?php
														$sel = "select count(customer_id) as id from tbl_customer";
														$result = $Conn->query($sel);
														$data = $result->fetch_assoc();
														echo $data["id"];
                                                        ?>
                            ...
                            <div class="white_box card_height_100">
                                <div class="box_header border_bottom_1px  ">
                                    <div class="main-title">
                                        <h3 class="mb_25">Supplier</h3>
                                    </div>
                                </div>
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    <?php
                                        $selQry = "select * from tbl_supplier";
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Files/Farmer/Photo/<?php echo $data1["supplier_photo"] ?>" alt="">
                                        </div>
                                        <h4><?php echo $data1["supplier_name"] ?></h4>
                                        <p><?php echo $data1["supplier_contact"] ?></p>
                                    </div>
                                    <?php
                                        }
                                    ?>
                        ...
                        <div class="col-xl-12">
                            <div class="white_box card_height_100">
                                ...
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Files/User/Photo/<?php echo $data1["customer_photo"] ?>" alt="">
                                        </div>
                                        <h4><?php echo $data1["customer_name"] ?></h4>
                                        <p><?php echo $data1["customer_contact"] ?></p>
                                    </div>
                                    <?php
                                        }
                                    ?>
