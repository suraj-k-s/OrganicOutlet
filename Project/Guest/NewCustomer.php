...
if(isset($_POST["btnsave"]))
{
	...
	move_uploaded_file($path,"../Assets/Files/Customer/Photo/".$photo);
	...
	$insQry="insert into tbl_customer(customer_name,customer_email,customer_address,customer_contact,place_id,customer_password,customer_photo)values('".$_POST["txtname"]."','".$_POST["txtemail"]."','".$_POST["txtaddress"]."','".$_POST["txtcontact"]."','".$_POST["selplace"]."','".$_POST["txtpassword"]."','".$photo."')";
