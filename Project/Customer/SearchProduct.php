        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <ul class="list-group">
                        <?php                           
						 $selCat = "SELECT * from tbl_producttype";
                        ...
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" onclick="productCheck()" class="form-check-input product_check" value="<?php echo $row["producttype_id"]; ?>" id="producttype"><?php echo $row["producttype_name"]; ?>
                                </label>
                            </div>
                        </li>
                        <?php
...
<script src="../Assets/Template/Search/popper.min.js"></script>
        <script>
            ...
            {
                $.ajax({
                    url: "../Assets/AjaxPages/AjaxAddCart1.php?id=" + id,
            ...
            function productCheck(){
                    ...
                    var action = 'data';
                    var producttype = get_filter_text('producttype');
					var name = document.getElementById('txt_name').value;
					


                    $.ajax({
                        url: "../Assets/AjaxPages/AjaxSearchProduct1.php?action=" + action +"&producttype=" + producttype+"&name=" + name ,
                        success: function(response) {
